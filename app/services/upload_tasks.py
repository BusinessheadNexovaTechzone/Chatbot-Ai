    ...
    try:
        ...
        if chunks:
            ...
            try:
                ...
                logger.info(f"[{job_id}] Connected to vector database: TurboVec")
                ...
                for batch_idx in range(0, len(chunks), EMBED_BATCH_SIZE):
                    ...
                    try:
                        ...
                        # ======== VECTOR STORAGE ========
                        logger.debug(f"[{job_id}]   Storing vectors in TurboVec database...")
                ...
                verification_checks["vector_storage"] = f"✓ PASSED ({chunks_indexed} vectors stored in TurboVec)"
